...
#define TELEMETRY_PROP_NAME_LATITUDE "latitude"
#define TELEMETRY_PROP_NAME_LONGITUDE "longitude"
#define TELEMETRY_PROP_NAME_VELOCITY "velocity"
...
#define DOUBLE_DECIMAL_PLACE_DIGITS 6
#define TWO_DOUBLE_DECIMAL_PLACE_DIGITS 2
    ...
    size_t* payload_buffer_length)
{
  ...
  az_span json_span;
  float latitude, longitude, velocity;

  // Acquiring the simulated data.
  
  GPS_cordinates(&latitude, &longitude, &velocity);
